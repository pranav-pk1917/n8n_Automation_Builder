...
msg="$(code-review-graph status --repo "C:/Users/prana/OneDrive/Documents/Webley Media/WebleyTools/n8n-Scrapper+Builder/n8n_Automation_Builder" 2>&1 | head -n 1 || true)"
