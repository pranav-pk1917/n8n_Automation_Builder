# Keyword Categorization v4 - Better Pattern Matching
...
$negativePatterns = @(
    # HOSPITAL RANKINGS - information intent
    "hospital", "hospitals", "medical center", "medical centres",
    "clinic", "clinics", "healthcare facility",
    # RANKINGS/LISTS
    ...
    # EDUCATION/CAREER
    "nursing program", "residency", "medical school", "mbc program",
    "emba ", "mba ", "degree program", "training program",
    # MOVIE/RATINGS
...
function Test-KeywordIntent {
    ...
    # Check NEGATIVE patterns = information intent
...
Write-Host "=== CATEGORIZATION v4 ===" -ForegroundColor Cyan
Write-Host ""
