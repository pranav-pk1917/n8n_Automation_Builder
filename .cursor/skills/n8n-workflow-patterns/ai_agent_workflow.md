...
- Anthropic (Claude Sonnet 4, Claude Opus 4) — use `@n8n/n8n-nodes-langchain.anthropic`
- Google (Gemini 2.5 Flash, Gemini 3 Flash Preview) — use `@n8n/n8n-nodes-langchain.googleGemini`
- MiniMax, Moonshot Kimi — use respective LangChain nodes
...
**Rule of thumb**: if the agent can read the internet AND do an action the user can't undo, you need a guardrail between them.
...
```
Fast & cheap: Claude 4 Haiku, GPT-4o-mini
Balanced: Claude Sonnet 4, GPT-4o, Gemini 2.5 Flash
Powerful: Claude Opus 4, GPT-4.5, Gemini 3 Flash Preview
```
