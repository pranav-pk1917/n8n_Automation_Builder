...
### OpenAI (nodes-langchain.openAi) — Updated: 2026-05-28

AI operations - 234 templates

**Note**: The legacy `n8n-nodes-base.openAi` is deprecated. Use `@n8n/n8n-nodes-langchain.lmChatOpenAi` for chat models, or the standalone `@n8n/n8n-nodes-langchain.anthropic` / `@n8n/n8n-nodes-langchain.googleGemini` nodes for other providers.
